...
namespace VaynePlus.Utils
{
    ...
    public static class AntiGapCloser
    {
        ...
        public static void OnLoad(Menu mainMenu)
        {
            #region Aatrox
        ...
        private static void BuildMenu(Menu mainMenu)
        {
            GapCloserMenu = mainMenu.AddSubMenu("AntiGapcloser List", "vayneplus.agplist");
            GapCloserMenu.AddGroupLabel("AntiGapCloser - Settings");
            GapCloserMenu.Add("vayneplus.agplist.delay", new Slider("Delay", 0, 0, 1000));
            GapCloserMenu.AddSeparator();
            GapCloserMenu.AddGroupLabel("AntiGapCloser - Spells");
            {
                var enemyHeroesNames = HeroManager.Enemies.Select(hero => hero.ChampionName).ToList();
                ...
                foreach (var champ in enemyHeroesNames)
                {
                    ...
                    GapCloserMenu.AddGroupLabel(champ);
                    foreach (var gp in Spells.Where(h => h.ChampionName == champ))
                    {
                        GapCloserMenu.Add("vayneplus.agplist." + champ.ToLower() + "." + gp.Slot,
        ...
        {
            ActiveGapclosers.RemoveAll(entry => Game.Time > entry.GameTime + 900);
